        ...
        return [
            ...
            Tool(
                ...
                description=(
                    ...
                    "`filter='mine'` keeps only matters with unread items "
            ...
            Tool(
                ...
                description=(
                    ...
                    "user for confirmation, then call `create_matter`. New "
                    "categories default to public; only set "
                    "`new_category_visibility` when the user explicitly asks "
                    "to restrict the category itself. Never infer restriction "
                    "from the body text."
                ),
